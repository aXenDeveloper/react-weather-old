...
import RainView from '../views/weather/rainView';
import CloudView from '../views/weather/cloudView';

const Content = props => {

    const cloud = (
        <svg className='cloudSVG' xmlns="http://www.w3.org/2000/svg" viewBox="0 -87 463.83425 463">
    ...
    return (
        <div className='weather'>
            <RainView temp={props.temp} cloud={cloud} />
            <CloudView temp={props.temp} cloud={cloud} />
        </div>
    )
}
