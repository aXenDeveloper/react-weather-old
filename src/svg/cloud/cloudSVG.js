...
const cloudSVG = ({ onRain, onThunder, onTime, onCloud }) => {

    const cloud = (
        <svg className={`cloud:SVG cloud:SVG_${onCloud}`} viewBox="0 -87 463.83425 463" xmlns="http://www.w3.org/2000/svg">
...
cloudSVG.propTypes = {
    ...
    onThunder: PropTypes.bool, 
    onTime: PropTypes.string,
    onCloud: PropTypes.number.isRequired
};
